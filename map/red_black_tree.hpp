...
template <class Key_T, class Compare, class Allocator>
    class Red_Black_Tree : public Red_Black_Tree_Util<const Key_T, Compare, Allocator> {
		private:
			typedef typename Red_Black_Tree_Util<const Key_T, Compare, Allocator>::value_type				value_type;
			typedef typename Red_Black_Tree_Util<const Key_T, Compare, Allocator>::iterator				iterator;
			typedef typename Red_Black_Tree_Util<const Key_T, Compare, Allocator>::const_iterator			const_iterator;
